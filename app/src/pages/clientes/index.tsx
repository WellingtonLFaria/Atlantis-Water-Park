...
export default function Clientes() {
    ...
    const [dependente, setDependente] = useState<Dependente>(new Dependente("Ryan", "Ryan", new Date(), new Endereco("Rua João Pires Silveira Filho", "Residencial Dom Bosco", "São José dos Campos", "SP", "Brasil", "12225-882"), [new Telefone("12", "996680124")], [new Documento(TipoDocumento.RG, "561184574", new Date())], titular));
